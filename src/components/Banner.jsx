...
export default function Banner() {
  return (
    <section className="pb-[100px] pt-16 md:mt-[100px]">
      <div className="container mx-auto">
        <div className="grid items-center gap-6 md:grid-cols-2">
          ...
          <div>
            <h1 className="mb-1.5 text-[56px] font-bold leading-none text-[#db4a2b] lg:text-[73px] font-['League_Spartan'] tracking-[-5.5px]">
              Taskify
            </h1>
